...
Parâmetros de dev: `?hoje=2026-07-07&agora=15:30` (simular data/hora), `?seed=1` (dados de demonstração num store vazio), `?aba=evolucao`, `?tema=dark|light`, `?sos=doce&passo=3`, `?ressaca=1`.
