...
CATALOGO = {
    ...
    "TESTE 5km contrarrelogio": treino_corrida("TESTE 5km contrarrelogio", [
        ...
        DESAQ(),
    ], "Árbitro dos paces do bloco seguinte. Não sair voando no km 1."),
    ...
    # ---- Bloco de retorno da FASCITE PLANTAR (13/08/2026 — ver TODO v7.27) ----
    # Volume baixo e nenhum estímulo forte até 23/09. As zonas NÃO mudam: Z2 segue governado
    # por FC (teto 152) como no resto do catálogo — fascite muda quilometragem, não zona.
    "Retorno 5km facil": facil("Retorno 5km facil", 5, Z2, "1a corrida pós-fascite — run/walk 5:1 se incomodar"),
    "5km facil": facil("5km facil", 5, Z2, "Sem pace — cadência 170+"),
    "6km facil": facil("6km facil", 6, Z2, "Sem pace — cadência 170+"),
    "Longao 8km facil": facil("Longao 8km facil", 8, Z2, "Primeiro longo pós-fascite"),
    "Longao 10km facil": facil("Longao 10km facil", 10, Z2, "Ritmo constante, sem bloco final"),
    "Longao 12km": facil("Longao 12km", 12, Z2, "Ritmo constante, sem bloco final"),
    "Longao 14km constante": facil("Longao 14km constante", 14, Z2, "Ritmo o mais constante possível"),
    "Longao 15km cadencia": facil("Longao 15km cadencia", 15, Z2, "Passos curtos e rápidos — proteger a tíbia"),
    "Longao 14km cadencia": facil("Longao 14km cadencia", 14, Z2, "Passos curtos e rápidos — proteger a tíbia"),
    "Tempo Run 3km": tempo_run("Tempo Run 3km", 3, TEMPO_TAPER, "Primeiro estímulo forte pós-fascite"),
    "Tempo Run 5km CHECKPOINT": tempo_run("Tempo Run 5km CHECKPOINT", 5, TEMPO_CHECKPOINT,
        "Ensaio de RITMO DE PROVA, não de limiar — encurtado de 6 km (4a semana de volta)"),
    "Tempo Run 4km CHECKPOINT": tempo_run("Tempo Run 4km CHECKPOINT", 4, TEMPO_CHECKPOINT,
        "2a passada no RITMO DE PROVA - substituiu o contrarrelogio de 07/10 (ver TODO v7.32)"),
...
AGENDA = [
    ...
    # Reestruturado em 13/08/2026 por fascite plantar (ver TODO v7.27). As datas de 17/08 a
    # 04/09 sao zero impacto (bike/piscina) e NAO tem treino no relogio -- ficam fora da lista.
    ("2026-09-07", "Retorno 5km facil"),
    ("2026-09-09", "5km facil"),
    ("2026-09-10", "Social Run 5km"),
    ("2026-09-14", "Longao 8km facil"),
    ("2026-09-16", "6km facil"),
    ("2026-09-17", "Social Run 5km"),
    # 16/09/2026: o longão de 8 km de 14/09 não aconteceu (ver TODO v7.29) -- os longões andam 1
    # semana (8 -> 10 -> 10 deload -> 12 -> 14 -> 16), sem mexer em 26/10, 02/11 nem na prova.
    ("2026-09-21", "Longao 8km facil"),
    ("2026-09-23", "Tempo Run 3km"),
    ("2026-09-24", "Social Run 6km"),
    ("2026-09-28", "Longao 8km facil"),
    ("2026-09-30", "Tempo Run 5km CHECKPOINT"),
